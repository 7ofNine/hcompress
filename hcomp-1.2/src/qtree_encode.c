...
#ifdef __STDC__
extern void qtree_encode(MYFILE *outfile, int a[], int n, int nqx, int nqy, int nbitplanes)
#else
extern void qtree_encode(outfile,a,n,nqx,nqy,nbitplanes)
MYFILE *outfile;
int a[];
...
static int bufcopy(unsigned char a[], int n, unsigned char **bptr, unsigned char *bufend)
#else
static int bufcopy(a,n,bptr,bufend)
unsigned char a[];
int n;
unsigned char **bptr;
...
static void write_bdirect(MYFILE *outfile, unsigned char a[], int nqx, int nqy)
#else
static void write_bdirect(outfile,a,nqx,nqy)
MYFILE *outfile;
unsigned char a[];	/* must contain output of qtree_onebit */
int nqx,nqy;
#endif
{
int i;
